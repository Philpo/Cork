...
const vector<string> InputMessenger::SUPPORTED_MESSAGES = { POLL_INPUT_MESSAGE };

InputMessenger::InputMessenger() : player(nullptr) {
...
void InputMessenger::receiveMessage(IMessage& message) {
